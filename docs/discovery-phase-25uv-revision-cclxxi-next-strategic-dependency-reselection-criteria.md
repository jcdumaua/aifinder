# Phase 25UV — Revision CCLXXI Next Strategic Dependency Reselection Criteria
...
Define the criteria for selecting the next blocker after GAP-027 returns to the authoritative unresolved blocker ledger.
...
- `GAP-027`, because future live RLS verification requires a new governance chain;
