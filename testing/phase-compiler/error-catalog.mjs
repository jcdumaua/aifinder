const catalogDefinitions = {
  ...
  INSPECTION_CONTRACT_REFERENCE_INVALID: ['An inspection contract reference is duplicate, dangling, or not covered exactly once.', 'FIX_INSPECTION_CONTRACT_REFERENCES'],
  INSPECTION_AUTHORITY_MISMATCH: ['A bounded inspection contract is paired with noninspection or nonzero-effect authority.', 'USE_STATIC_INSPECTION_ONLY_ZERO_EFFECT_AUTHORITY'],
  INSPECTION_TEXT_FORBIDDEN: ['Inspection text is outside the closed version-1 static-inspection vocabulary, semantic templates, or syntax bounds.', 'USE_CLOSED_V1_INSPECTION_TEXT'],
